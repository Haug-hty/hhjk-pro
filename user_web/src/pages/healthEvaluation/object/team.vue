...
<template>
    <main>
        ...
        <el-table :data="teamTableData" stripe style="width: 100%;font-size: 12px;text-align: center;" :header-cell-style="{background:'#eef1f6',color:'#606266',fontSize:'14px',borderBottom:'1px solid #000'}">
            <!-- :height="tableMaxHeight"> -->
            <el-table-column type='index' label="序号" width="50" align="center" header-align="center">
            </el-table-column>
            <el-table-column prop="name" label="小组名称" align="center" header-align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="leader" label="负责人" width="100" align="center" header-align="center" >
            </el-table-column>
            <el-table-column prop="tel" label="联系电话" align="center" header-align="center" :show-overflow-tooltip="true">
            </el-table-column>
        ...
        <!-- 新增小组信息 -->
        <el-dialog :close-on-click-modal="false" append-to-body :visible.sync="dialogFormVisible" width='50%' title="评估小组新增">
            <el-row :gutter="15">
                <el-form ref="elForm" :model="newTeamForm" size="medium" label-width="100px" :rules="rules">
                    <el-col :span="20">
                        <el-form-item label-width="120px" label="小组名称：" prop="name">
                            <el-input v-model="newTeamForm.name" clearable :style="{width: '80%'}"></el-input>

                        </el-form-item>
                    </el-col>
                    <el-col :span="20">
                        <el-form-item label-width="120px" label="负责人：" prop="leader">
                            <el-input v-model="newTeamForm.leader" clearable :style="{width: '80%'}"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="20">
                        <el-form-item label-width="120px" label="联系方式：" prop="tel">
                            <el-input v-model="newTeamForm.tel" maxlength="11" clearable :style="{width: '80%'}"></el-input>
                        </el-form-item>
                    </el-col>
                </el-form>
        ...
        <!-- 编辑小组信息 -->
        <el-dialog :close-on-click-modal="false" append-to-body :visible.sync="dialogEditForm" width='60%' >
            <el-row :gutter="15">
        ...
        <!-- 成员信息编辑 -->
        <el-dialog :close-on-click-modal="false" append-to-body :visible.sync="teamUserFlag" width='700px' title="小组成员管理">
...
<script>
    import { team_info_query, team_addInfo, team_delInfo } from "@/api/rlObject/index"
    import { teamMember, teamMemberBind } from "@/api/system/index"
    export default {
