...
//新增文本资料信息
export const knowledge_newInfo_submit = (params) => {
    return request.post(`${BASE_URL}/admin/knowledgeBase/save`,params)
};

//查询文本资料信息
export const knowledge_table_search = (params) => {
    return request.post(`${BASE_URL}/admin/knowledgeBase/listPage`,params)
};

//删除科研成果信息
export const knowledge_delInfo = (id) => {
    return request.get(`${BASE_URL}/admin/knowledgeBase/deleteById/`+id)
};